                ...
                <div class="panel-body">
                    <div class="col-md-6">
                        <form role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="prd_warranty" value="<?php echo $row_prd['prd_warranty'];?>" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Phụ kiện</label>
                                <input type="text" name="prd_accessories" value="<?php echo $row_prd['prd_accessories'];?>" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Khuyến mãi</label>
                                <input type="text" name="prd_promotion" value="<?php echo $row_prd['prd_promotion'];?>" class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Title</label>
                                <input type="text" name="title" value="<?php echo $row_prd['prd_title'];?>" type="text" class="form-control">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <br>
                            <div>
                                <img width="100%" src="img/product/<?php echo $row_prd['prd_image'];?>">
                            </div>
                        </div>
                        <div class="form-group">
