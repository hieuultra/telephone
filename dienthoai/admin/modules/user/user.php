...
$user_id_current = $row_user['user_id'];
?>
                ...
                <div class="panel-body">
                    <table data-toolbar="#toolbar" data-toggle="table">
                        ...
                        <tbody>
                            ...
                            $total_page = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM user ORDER BY user_id DESC"));
                            ...
                            while ($row = mysqli_fetch_array($query)) { ?>
                                <tr>
                                    ...
                                    <td><span class="label label-<?php if($row['user_level']==1){echo "danger";}else{echo 'success';}?>"><?php if($row['user_level']==1){echo 'Admin';}else{echo 'Customer';}?></span></td>
                                    <td class="form-group">
                                        <?php if($user_id_current != $row['user_id']){ ?>
