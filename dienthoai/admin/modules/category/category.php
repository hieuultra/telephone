				...
				<div class="panel-body">
					<table data-toolbar="#toolbar" data-toggle="table">
						...
						<tbody>
							...
							$query = mysqli_query($conn, "SELECT * FROM category ORDER BY category.cat_id ASC LIMIT $per_page,$row_per_page");
							while ($row=mysqli_fetch_array($query)) { ?>
								<tr>
									...
									<td class="form-group">
										...
										<a href="del_category.php?id=<?php echo $row['cat_id'];?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
									</td>
								</tr>
							<?php } ?>
						</tbody>
